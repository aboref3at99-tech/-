...
class VideoApiTests(unittest.TestCase):
    ...
    def test_video_project_lifecycle(self):
        ...
        list_response = self.client.get("/video/projects")
        self.assertEqual(list_response.status_code, 200)
        self.assertGreaterEqual(len(list_response.json()["projects"]), 1)

        plan_response = self.client.post(f"/video/projects/{project_id}/plan")
        ...
        get_response = self.client.get(f"/video/projects/{project_id}")
        ...
        delete_response = self.client.delete(f"/video/projects/{project_id}")
